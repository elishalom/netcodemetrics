...
{
    public class DeclarationPropertyTypeConvertor : IPropertyConvertor
    {
        ...
        public DeclarationPropertyTypeConvertor(IPropertyDeclarationFactory propertyDeclarationFactory, ILocationFactory locationFactory, IUnderlyingObjectFactory underlyingObjectFactory)
        {
        ...
        public PropertyType TargetType => PropertyType.Declaration;
