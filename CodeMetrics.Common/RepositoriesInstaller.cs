...
namespace CodeMetrics.Common
{
    public class RepositoriesInstaller : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            ...
            container.Register(Component.For<IMethodsVisitorFactory>().ImplementedBy<MethodsVisitorFactory>().LifeStyle.Transient);
            ...
            container.Register(Component.For<IMethodsVisitor>().ImplementedBy<ConstructorsVisitor>().LifeStyle.Transient);
